		...
		<ul class="divided">
            ...
            <li>
                <article class="box excerpt">
                    ...
                    <p>
                        <input type="checkbox" name="category[{$category.name}]" id="{$category.name}" class="css-checkbox filterProducts" value="{$category.name}" {if isset($selected[$manufacture.name])}checked="" style="background-position: 0 -35px;"{/if} />
        ...
        <ul class="divided">
            ...
            <li>
                <article class="box excerpt">
                    ...
                    <p>
                        <input type="checkbox" name="manufacturers[{$manufacture.name}]" id="{$manufacture.name}" class="css-checkbox filterProducts" value="{$manufacture.name}" {if isset($selected[$manufacture.name])}checked="" style="background-position: 0 -35px;"{/if} />
