					...
					<div class="row">
                        ...
                        {foreach from=$products key=key item=product}
        					<div class="4u" style="width: 25%;padding: 25px 25px 25px 25px;min-height: 36em;position: relative;">
        						<a href="{$product.prod_code}.php" class="image featured"><img src="img/products/{$product.image_path}" alt="" width="100" /></a>
        						<header>
        							<h3><a href="{$product.prod_code}.php">{$product.name}</a></h3>
        						</header>
                                <footer>
